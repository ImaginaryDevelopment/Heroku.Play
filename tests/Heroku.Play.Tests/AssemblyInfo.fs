...
[<assembly: AssemblyTitleAttribute("Heroku.Play.Tests")>]
[<assembly: AssemblyProductAttribute("Heroku.Play")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "Heroku.Play.Tests"
    let [<Literal>] AssemblyProduct = "Heroku.Play"
